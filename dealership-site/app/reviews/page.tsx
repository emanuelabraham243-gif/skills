...
export const metadata: Metadata = {
  title: "Reviews",
  description: "Approved reviews from customers who bought their car with us.",
};
  ...
  return (
    <div className="container-page py-10 sm:py-14">
      <SectionHeading
        ...
        description="Every review here comes from a verified buyer and is manually approved before publishing."
      />
          ...
          <div key={review.id} className="mb-5 break-inside-avoid rounded-2xl border border-line bg-white p-6">
            ...
            <div className="mt-4 flex items-center justify-between text-xs text-ink-soft">
              <span className="font-medium text-ink">
                {review.customerName}
                {review.carLabel && <span className="font-normal text-ink-soft"> · {review.carLabel}</span>}
              </span>
